...
#manipulations
btn_div = Button(frame_btns, text = '/',     bg = '#202020', fg = "#FFFFFF", bd = 1, width=btn_width, height=btn_height, font=30 , command=lambda: button_click('/') )
btn_div.grid(row = 0, column=3,)
btn_mult = Button(frame_btns, text = '*',     bg = '#202020', fg = "#FFFFFF", bd = 1, width=btn_width, height=btn_height, font = 30, command=lambda: button_click('*')  )
btn_mult.grid(row = 1, column=3,)
btn_min = Button(frame_btns, text = '-',     bg = '#202020', fg = "#FFFFFF", bd = 1, width=btn_width, height=btn_height, font=30 , command=lambda: button_click('-') )
btn_min.grid(row = 2, column=3,)
btn_plus = Button(frame_btns, text = '+',     bg = '#202020', fg = "#FFFFFF", bd = 1, width=btn_width, height=btn_height, font=30, command=lambda: button_click('+')  )
